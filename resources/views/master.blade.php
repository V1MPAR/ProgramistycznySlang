...
<html lang="pl">
  <head>
    ...
    <title>Programistyczny Slang</title>
  ...
  <body>
                          ...
                          <ul class="list-inline">
                              ...
                              @foreach ( $letters as $letter )
                                  <li class="list-inline-item">
                                      <a href="{{ URL::to('/letter/' . $letter) }}">{{ $letter }}</a>
                                  </li>
                              @endforeach
                          </ul>
                      </div>
      ...
      <script src="{{ URL::asset('js/master.js?' . time()) }}"></script>
      <script src="{{ URL::asset('js/dynamic.js?' . time()) }}"></script>
